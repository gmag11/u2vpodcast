...
Defines the ability to re-read a channel's YouTube cover image URL on demand and to refresh it from the channel card in the SPA, without triggering an episode refresh.
