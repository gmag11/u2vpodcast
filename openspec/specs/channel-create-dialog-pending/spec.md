# channel-create-dialog-pending

## Purpose

Defines the pending state of the Add Channel dialog while its save request (including the upstream link check) is in flight — both action buttons disabled and a spinner shown in place of the primary button label.
