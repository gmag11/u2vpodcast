...
Defines how the app stores, propagates, and applies a per-channel playback speed preference so every episode of a channel starts at its saved rate and changes are persisted server-side.
